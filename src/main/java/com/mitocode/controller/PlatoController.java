...
public class PlatoController {
	...
	@PostMapping
	public Mono<ResponseEntity<Plato>> registrar(@RequestBody Plato p, final ServerHttpRequest req) {
	...
	@PutMapping("/{id}")
	public Mono<ResponseEntity<Plato>> modificar(@PathVariable("id") String id, @RequestBody Plato p) {
